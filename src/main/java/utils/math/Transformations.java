...
public final class Transformations {
    ...
    public static InertialFrameVelocity bodyFrameVelocityToInertialFrameVelocity(
        ...
        final double linearX =
                bodyFrameVelocity.linearX() * cos - bodyFrameVelocity.linearY() * sin;
        final double linearY =
                bodyFrameVelocity.linearX() * sin + bodyFrameVelocity.linearY() * cos;
