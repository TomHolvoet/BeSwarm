...
/**
 * Tests for {@link MaxDiffBodyFrameVelocityFilter}.
 *
 * @author Hoang Tung Dinh
 */
public class MaxDiffBodyFrameVelocityFilterTest {
  @Test(expected = IllegalArgumentException.class)
  public void testIllegalMaxDifference() {
    MaxDiffBodyFrameVelocityFilter.create(mock(Velocity4dService.class), -0.1);
  }
  ...
  public void testFilter() {
    ...
    final Velocity4dService velocityFilter =
        MaxDiffBodyFrameVelocityFilter.create(velocity4dService, 0.1);
    ...
    TestUtils.assertVelocityEqual(v2, argumentCaptor.getValue());
  }
}
