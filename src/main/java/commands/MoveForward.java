...
public final class MoveForward implements Command {
    ...
    private MoveForward(VelocityService velocityPublisher, double speed, double durationInSeconds) {
        this.velocityPublisher = velocityPublisher;
        this.speed = speed;
        this.durationInSeconds = durationInSeconds;
    }

    public static MoveForward create(VelocityService velocityPublisher, double speed, double durationInSeconds) {
