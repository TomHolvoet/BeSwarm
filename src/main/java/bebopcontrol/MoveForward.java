...
public final class MoveForward implements Command {
    ...
    private MoveForward(Publisher<Twist> publisher, double speed, double durationInSeconds) {
        this.publisher = publisher;
        this.speed = speed;
        this.durationInSeconds = durationInSeconds;
    }

    public static MoveForward create(Publisher<Twist> publisher, double speed, double durationInSeconds) {
        ...
        return new MoveForward(publisher, speed, durationInSeconds);
    }
