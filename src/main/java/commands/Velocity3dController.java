...
final class Velocity3dController implements VelocityController {
  ...
  private Velocity3dController(Builder builder) {
    ...
    pidControllerLinearZ =
        PidController1d.create(
            builder.pidLinearZ, TrajectoryUtils.getTrajectoryLinearZ(trajectory4d));
  }
  ...
  public static final class Builder extends BuilderWithVelocity3dService<Builder> {
     ...
     *
     * @return a {@code Velocity3dController} built with parameters of this {@code
     *     Velocity3dController.Builder}
     */
