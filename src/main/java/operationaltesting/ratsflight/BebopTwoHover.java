...
/**
 * Bebop starts at x=0, y=-5, yaw = -pi/2.
 *
 * @author Hoang Tung Dinh
 */
public final class BebopTwoHover extends AbstractNodeMain {
  @Override
  public GraphName getDefaultNodeName() {
    return GraphName.of("BebopTwo");
  }

  @Override
  public void onStart(ConnectedNode connectedNode) {
    final Trajectory4d rawTrajectory =
        Trajectories.newHoldPositionTrajectory(Point4D.create(0, -2, 1, -StrictMath.PI / 2));
