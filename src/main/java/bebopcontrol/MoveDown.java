...
public final class MoveDown implements Command {
    ...
    private MoveDown(Publisher<Twist> publisher, double speed, double durationInSeconds) {
        this.publisher = publisher;
        this.speed = speed;
        this.durationInSeconds = durationInSeconds;
    }

    public static MoveDown create(Publisher<Twist> publisher, double speed, double durationInSeconds) {
        ...
        return new MoveDown(publisher, speed, durationInSeconds);
    }
