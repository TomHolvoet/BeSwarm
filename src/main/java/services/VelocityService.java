...
public final class VelocityService {
    ...
    private VelocityService(Builder builder) {
     ...
     */
    public void publishVelocityMessage(Velocity velocity) {
    ...
    public static Builder createServiceBuilder(String droneName, ConnectedNode connectedNode) {
    	return VelocityService.builder().publisher(connectedNode.<Twist>newPublisher(droneName + "cmd/vel", Twist._TYPE));
    }
    ...
    public static final class Builder {
         ...
         */
        public VelocityService build() {
            return new VelocityService(this);
        }
    }
}
