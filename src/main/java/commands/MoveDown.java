...
public final class MoveDown implements Command {
    ...
    private MoveDown(VelocityService velocityPublisher, double speed, double durationInSeconds) {
        this.velocityPublisher = velocityPublisher;
        this.speed = speed;
        this.durationInSeconds = durationInSeconds;
    }

    public static MoveDown create(VelocityService velocityPublisher, double speed, double durationInSeconds) {
