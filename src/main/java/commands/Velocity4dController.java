...
final class Velocity4dController implements VelocityController {
  ...
  private Velocity4dController(
      Velocity4dService velocity4dService, PidController4d pidController4d) {
  ...
  public static final class Builder extends BuilderWithVelocity4dService<Builder> {
     ...
     *
     * @return a {@code Velocity4dController} built with parameters of this {@code
     *     Velocity4dController.Builder}
     */
    public Velocity4dController build() {
      ...
      final PidController4d pidController4d =
