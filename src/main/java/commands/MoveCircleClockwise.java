...
public final class MoveCircleClockwise implements Command {
    ...
    private MoveCircleClockwise(ParrotVelocityService velocityPublisher, double forwardSpeed, double rotationSpeed,
    ...
    public static MoveCircleClockwise create(ParrotVelocityService velocityPublisher, double forwardSpeed,
