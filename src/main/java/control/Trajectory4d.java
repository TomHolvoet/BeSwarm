...
public interface Trajectory4d {
    ...
    /**
     * @param timeInSeconds the point in time to get the position for.
     * @return The desired value of the momentary velocity component relative to the x axis. for the given point in
     * time.
     */
    ...
    /**
     * @param timeInSeconds the point in time to get the position for.
     * @return The desired value of the momentary velocity component relative to the yaxis. for the given point in time.
     */
    ...
    /**
     * @param timeInSeconds the point in time to get the position for.
     * @return The desired value of the momentary velocity component relative to the z axis. for the given point in
     * time.
     */
    ...
    /**
     * @param timeInSeconds the point in time to get the position for.
     * @return The desired value of the angular velocity (or rate of change of the angle) around the z-axis.
     */
