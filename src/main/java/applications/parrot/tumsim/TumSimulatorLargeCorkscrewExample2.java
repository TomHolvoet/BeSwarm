 ...
 */
public class TumSimulatorLargeCorkscrewExample2 extends AbstractTumSimulatorExample {

  /** Default constructor. */
  public TumSimulatorLargeCorkscrewExample2() {
    super("TumLargeCorkscrewTrajectory2");
  }
