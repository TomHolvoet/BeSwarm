...
public final class MoveCircleCounterClockwise implements Command {
    ...
    private MoveCircleCounterClockwise(Publisher<Twist> publisher, double forwardSpeed, double rotationSpeed,
    ...
    public static MoveCircleCounterClockwise create(Publisher<Twist> publisher, double forwardSpeed,
        ...
        return new MoveCircleCounterClockwise(publisher, forwardSpeed, rotationSpeed, durationInSeconds);
    }
