...
public final class RotateClockwise implements Command {
    ...
    private RotateClockwise(Publisher<Twist> publisher, double speed, double durationInSeconds) {
        this.publisher = publisher;
        this.speed = speed;
        this.durationInSeconds = durationInSeconds;
    }

    public static RotateClockwise create(Publisher<Twist> publisher, double speed, double durationInSeconds) {
        ...
        return new RotateClockwise(publisher, speed, durationInSeconds);
    }
