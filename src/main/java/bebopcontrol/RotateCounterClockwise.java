...
public final class RotateCounterClockwise implements Command {
    ...
    private RotateCounterClockwise(Publisher<Twist> publisher, double speed, double durationInSeconds) {
        this.publisher = publisher;
        this.speed = speed;
        this.durationInSeconds = durationInSeconds;
    }

    public static RotateCounterClockwise create(Publisher<Twist> publisher, double speed, double durationInSeconds) {
        ...
        return new RotateCounterClockwise(publisher, speed, durationInSeconds);
    }
