 ...
 */
class AbstractUncheckedStraightLineTrajectory4D extends BasicTrajectory
  ...
  AbstractUncheckedStraightLineTrajectory4D(
  ...
  public String toString() {
    return "AbstractUncheckedStraightLineTrajectory4D{"
        + "velocity="
        + getVelocity()
        + ", src point="
        + getSrcpoint()
